...
<body>
    ...
    <div class="container">
        <div class="subcontainer1">
            <div class="collage">
                <a href="galeria_admin.php"> <img class= collageimg src="../Imagenes/PELUSA2.jpg" alt=""></a>
            </div>
            <div class="consejo">
        ...
        <div class="subcontainer2">
           <a href="noticias_admin.php"> <img class="michinoticias" src="../Imagenes/MICHINOTICIAS.png" alt=""> </a>
